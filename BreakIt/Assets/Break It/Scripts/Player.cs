...
public class Player : MonoBehaviour {
	...
	void Die(){
		if(isIgnore==false)
		{
            GameObject.FindObjectOfType<GameManager>().PauseScene(0);
	...
	void PaintEffect(){
		...
		GameObject paintSplat = muchPaint ? paintSplats[2] : paintSplats[UnityEngine.Random.Range(0, paintSplats.Length - 1)];
